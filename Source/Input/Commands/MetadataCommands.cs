...
*/
    ...
    [TasCommand("RecordCount", Aliases = ["RecordCount:", "RecordCount："], CalcChecksum = false,
        MetaDataProvider = typeof(RecordCountMeta))]
    ...
    [TasCommand("MidwayChapterTime", Aliases = new[] { "MidwayChapterTime:", "MidwayChapterTime：" },
        CalcChecksum = false)]
    private static void MidwayChapterTimeCommand(CommandLine commandLine, int studioLine, string filePath,
        int fileLine) {
