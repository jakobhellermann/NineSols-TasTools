...
public static class Hotkeys {
    ...
    public static Hotkey Hitboxes { get; }
    public static Hotkey TriggerHitboxes { get; }
    public static Hotkey SimplifiedGraphic { get; }
    public static Hotkey CenterCamera { get; }
    public static Hotkey LockCamera { get; }
    public static Hotkey SaveState { get; }
    public static Hotkey ClearState { get; }
    public static Hotkey InfoHud { get; }
    public static Hotkey FreeCamera { get; }
    public static Hotkey CameraUp { get; }
    public static Hotkey CameraDown { get; }
    public static Hotkey CameraLeft { get; }
    public static Hotkey CameraRight { get; }
    public static Hotkey CameraZoomIn { get; }
    public static Hotkey CameraZoomOut { get; }
    ...
    public static Dictionary<HotkeyID, List<KeyCode>> KeysInteractWithStudio = new();

    private static readonly List<HotkeyID> HotkeyIDsIgnoreOnStudio = new() {
        HotkeyID.InfoHud, HotkeyID.FreeCamera, HotkeyID.CameraUp, HotkeyID.CameraDown, HotkeyID.CameraLeft,
        HotkeyID.CameraRight,
    ...
    private static void InputInitialize() {
        ...
        hotKeysInteractWithStudio = KeysDict.Where(pair => !HotkeyIDsIgnoreOnStudio.Contains(pair.Key))
    ...
    */
    ...
    public class Hotkey {
        ...
        public Hotkey(List<KeyCode> keys, List<Buttons> buttons, bool keyCombo, bool held) {
            Keys = keys;
            Buttons = buttons;
        ...
        private bool IsButtonDown() {
            ...
            return keyCombo
                ...
                : Buttons.Any(UnityEngine.Input.GetMouseButtonDown);
        }
...
public class DefaultButtonBinding2Attribute : DefaultButtonBindingAttribute {
    ...
    public DefaultButtonBinding2Attribute(Buttons button, params XNAKeys[] keys) : base(button,
        keys.IsEmpty() ? XNAKeys.None : keys[0]) {
